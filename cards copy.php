            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="cards copy.html">Entrega de Vehiculos</a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Entrega de Vehiculos <i class="fas fa-car"></i></h1>
                    </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Paso 1: </div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Verificar Clientes</div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Paso 2: </div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Registrar Clientes</div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Paso 3: 
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">Abir un Contrato</div>
                                                </div>
                                                <div class="col">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Paso 4: </div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Notificarle al Cliente</div>
                                        </div>
                                        <div class="col-auto">
...
$insert_value = 'SELECT * FROM `' . $db_name . '`.`'.$db_table_name.'` WHERE `id_dui` = "' . $subs_duii . '"';

mysqli_select_db($link, $db_name);
$retry_value = mysqli_query($link, $insert_value);

if($row = mysqli_fetch_row($retry_value)){
    echo "<form class='user' action='verificar_update.php' method='POST'>";
    ...
    echo "</div>";
    echo "<hr>";
    echo "<input type='submit' class='btn btn-primary btn-user btn-block font-weight-bold text-white' value='ACTUALIZAR CLIENTE'/>";
    echo "</form>";
}
