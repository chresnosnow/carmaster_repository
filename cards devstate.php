            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item active" href="cards devo.html">Devolución de Vehiculos</a>
                        ...
                        <div class="col-lg">
                            ...
                            <div class="card mb-4">
                                <div class="card-header font-weight-bold text-primary" style="text-align: center;" >
                                    Modificacion de Estado de Contrato Vigente
                                </div>
                                <div class="card-body">
...
if($row = mysqli_fetch_row($retry_value)){
    echo "<form class='user' action='cards devupdatea.php' method='POST'>";
    ...
    placeholder='Numero de Placa' name='id_placa' value='".$row[2]."' readonly/>";
    echo "</div>";
    ...
    echo "</div>";
    echo "<div class='form-group'>";
    echo "Fecha Incial de Contrato: <input type='TEXT' class='form-control form-control-user' id='exampleFirstName'
    placeholder='Fecha Inicial' name='fechini' value='".$row[4]."' readonly/>";
    echo "</div>";
    echo "<div class='form-group row'>";
    echo "<div class='col-sm-6 mb-3 mb-sm-0'>";
    echo "Fecha Final de Contrato: <input type='TEXT' class='form-control form-control-user' id='exampleFirstName'
    placeholder='Fecha Final' name='fechafin' value='".$row[5]."' readonly/>";
    echo "</div>";
    echo "<div class='col-sm-6'>";
    echo "Costo de Contrato: <input type='TEXT' class='form-control form-control-user' id='exampleFirstName'
    placeholder='Costo' name='costo' value='".$row[6]."' readonly/>";
    echo "</div>";
    echo "</div>";
    echo "<div class='form-group row'>";
    echo "<div class='col-sm-6 mb-3 mb-sm-0'>";
    echo "ESTADO DE CONTRATO: <select name='estado'>";
    echo "<option value='1'>ACTIVO</option>";
    echo "<option value='2'>FINALIZADO</option>";
    echo "<option value='3'>DADO DE BAJA</option>";
    echo "</select>";
    echo "</div>";
    echo "</div>";
    echo "<hr>";
